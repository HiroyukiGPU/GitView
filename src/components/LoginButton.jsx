...
function LoginButton() {
  ...
  if (user) {
    return (
      <div className="login-button">
        <div className="login-button__user">
          <img
            ...
            className="login-button__avatar"
          />
          <span className="login-button__name">
        ...
        {error && <div className="login-button__error">{error}</div>}
      </div>
    );
  }
  ...
  return (
    <div className="login-button">
      <div className="login-button__buttons">
        <button
          className="login-button__google"
          onClick={handleGoogleLogin}
          disabled={isLoading}
        >
          <svg className="login-button__icon" viewBox="0 0 24 24" width="18" height="18">
        ...
        <button
          className="login-button__github"
          onClick={handleGitHubLogin}
          disabled={isLoading}
        >
          <svg className="login-button__icon" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
      ...
      {error && <div className="login-button__error">{error}</div>}
      {isLoading && <div className="login-button__loading">ログイン中...</div>}
    </div>
  );
}
